...
$ make
$ ./gem5.debug -rs avx/test_bench.py
'''

# Define the path to your compiled test binary containing the custom instructions
binary_path = Path("/home/sjaguri/gem5-amx/avx/load_test")
...
# Setup the doard (SimpleBoard is specifically used for SE mode)
board = SimpleBoard(
    clk_freq="1GHz",
    processor=processor,
    memory=memory,
...
def workend_handler():
    ...
    yield False  # Yielding True tells the simulator to stop


# 6. Setup and Run Simulator
simulator = Simulator(
    board=board,
    on_exit_event={
